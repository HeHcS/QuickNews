    ...
    <AnimatePresence>
      ...
      >
        <motion.div 
          ...
          className="w-full bg-dark rounded-t-3xl p-4 max-h-[80vh] overflow-hidden flex flex-col"
        >
          ...
          {/* Comment input */}
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-dark border-t border-darkGray">
